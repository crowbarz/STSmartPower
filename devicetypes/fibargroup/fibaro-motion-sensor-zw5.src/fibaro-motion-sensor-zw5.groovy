 ...
 *
 *  https://github.com/richb1/FIBARO-Official-SmartThings-Device-Handlers/blob/master/FIBARO-%20Motion%20ZW5
 *
...
private syncCheck() {
    ...
    if (failed) {
        ...
        multiStatusEvent("Sync incomplete! Wake up the device again by pressing the sync button.", true, true)
    } else {
...
private parameterMap() {[
        [key: "motionSensitivity", num: 1, size: 2, type: "enum", options: [
                ...
                200: "Low sensitivity"
        ], def: 15, min: 8, max: 255, title: "Motion detection - sensitivity",
         descr: "The lower the value, the more sensitive the PIR sensor is."],
        ...
        [key: "motionOperatingMode", num: 8, size: 1, type: "enum", options: [
                0: "Always Active (default)",
                1: "Active During Day",
                2: "Active During Night"
        ], def: 0, title: "Motion detection - operating mode",
        ...
        [key: "tamperOperatingMode", num: 24, size: 1, type: "enum", options: [
                0: "tamper only (default)",
                1: "tamper and earthquake detector",
                2: "tamper and orientation"
        ], def: 0, title: "Tamper - operating modes",
        ...
        [key: "illuminanceInterval", num: 42, size: 2, type: "number", def: 3600, min: 0, max: 32767, title: "Illuminance report - interval",
         descr: "Time interval between consecutive illuminance reports. The reports are sent even if there is no change in the light intensity. (1-32767 in sec)"],
        ...
        [key: "temperatureInterval", num: 64, size: 2, type: "number", def: 0, min: 0, max: 32767, title: "Temperature report - interval",
         descr: "Time interval between consecutive temperature reports. The reports are sent even if there is no change in the temperature. (1-32767 in sec)"],
        [key: "temperatureOffset", num: 66, size: 2, type: "number", def: 0, min: -1000, max: 1000, title: "Temperature offset",
         descr: "The value to be added to the actual temperature, measured by the sensor (temperature compensation). (0-1000 for +0.0 - +100.0C, 64536-65535 for -100.0C -- -0.1C)"],
        ...
        ], def: "10", title: "Visual LED indicator - signalling mode",
         descr: "This parameter determines the way in which visual indicator behaves after motion has been detected."],
