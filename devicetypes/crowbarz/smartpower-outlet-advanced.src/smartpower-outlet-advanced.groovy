...
metadata {
	...
	definition(name: "SmartPower Outlet (Advanced)", namespace: "crowbarz", author: "Crow Bar/SmartThings", ocfDeviceType: "oic.d.smartplug", minHubCoreVersion: '000.017.0012', executeCommandsLocally: false, mnmn: "SmartThings", vid: "generic-switch-power") {
		capability "Actuator"
		capability "Switch"
